...
@rem ##########################################################################
@rem
@rem  Furphobia startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FURPHOBIA_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FURPHOBIA_OPTS%  -classpath "%CLASSPATH%" com.tacaly.furphobia.Main %*
...
:fail
rem Set variable FURPHOBIA_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%FURPHOBIA_EXIT_CONSOLE%" exit 1
exit /b 1
